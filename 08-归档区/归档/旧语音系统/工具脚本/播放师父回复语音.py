...
用法:
    .venv/bin/python3 工具脚本/播放师父回复语音.py "要播放的文本"
...
async def generate_and_play(text: str, voice: str = "zh-CN-XiaoyiNeural") -> None:
    """生成并播放单段语音。"""
    with tempfile.NamedTemporaryFile(suffix='.mp3', delete=False, dir='/Users/lingjue/Documents/shutong/临时交付') as tmp:
...
async def main():
    if len(sys.argv) < 2:
        print("用法: .venv/bin/python3 工具脚本/播放师父回复语音.py \"要播放的文本\"")
        sys.exit(1)
