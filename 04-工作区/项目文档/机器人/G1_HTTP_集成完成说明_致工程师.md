...
- **当前生效文档：`04-工作区/项目文档/机器人/G1_CONTROL_CLIENT.md`（V2 实测修订版）**
- 历史副本：`04-工作区/项目文档/机器人/G1_CONTROL_CLIENT_V2.md`

### 2. Python HTTP 客户端

- 文件：`03-引擎区/书童程序/核心/机器人对接/G1_HTTP客户端.py`
- 封装接口：
...
- 文件：`03-引擎区/书童程序/核心/机器人对接/音频格式转换.py`
- 功能：
...
- 文件：`03-引擎区/书童程序/数据/提示词/G1动作解析提示词.md`
- V2 变化：
...
- 文件：`03-引擎区/书童程序/核心/机器人对接/情感动作库.py`
- 已适配 V2：
...
- 文件：`03-引擎区/书童程序/配置.py`、`01-配置区/config.json.template`
- 更新配置：
  ```json
  {
