...
- 语音识别：Whisper
- 语音合成：edge_tTS
- 核心文件：`00-灵魂区/AGENTS.md`、`00-灵魂区/WORKFLOW.md`
...
| `03-引擎区/书童程序/核心/机器人桥接.py` | 书童系统调用 G1 的 Python 模块 |
| `04-工作区/项目文档/产品资料/书童AI-宇树G1部署所需工程师与团队配置_V1.0.md` | 团队配置建议 |
