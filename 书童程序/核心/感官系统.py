...
class SensorySystem:
    ...
    def __init__(self, journal_dir=None, config=None):
        self.journal_dir = Path(journal_dir) if journal_dir else Path("/Users/lingjue/Documents/shutong/书童程序/数据/感官日志")
...
class VisionSensor:
    ...
    def __init__(self, journal_dir):
        ...
        self.face_model_path = self.project_root / "书童程序" / "数据" / "模型" / "face_landmarker.task"
        self.face_features_dir = self.project_root / "书童程序" / "数据" / "人脸特征"
