...
class DailyWorkflow:
    ...
    def _append_to_companion_log(self, child_name, task_name, content):
        ...
        log_file = Path("/Users/lingjue/Documents/shutong/档案区/陪伴日志") / f"{date_str}_{child_name}.md"
    ...
    def _check_missing_logs(self):
        ...
        for child in self.bookboy.profile_manager.get_all_children():
            log_file = Path("/Users/lingjue/Documents/shutong/档案区/陪伴日志") / f"{date_str}_{child.name}.md"
    ...
    def generate_daily_report(self):
        ...
        # 统计今日陪伴日志
        log_dir = Path("/Users/lingjue/Documents/shutong/档案区/陪伴日志")
