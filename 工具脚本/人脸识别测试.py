...
def capture_test_photo(project_root):
    ...
    save_dir = project_root / "工具脚本" / "摄像头测试截图"
...
if __name__ == "__main__":
    ...
    model_path = project_root / "书童程序" / "数据" / "模型" / "face_landmarker.task"
    features_dir = project_root / "书童程序" / "数据" / "人脸特征"
    ...
    if test_image:
        ...
        # 如果拍照失败，用已有照片
        test_image = project_root / "工具脚本" / "摄像头测试截图" / "video_frame_at_5s.jpg"
