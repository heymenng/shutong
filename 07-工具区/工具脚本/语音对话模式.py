...
使用方法：
    python3 07-工具区/工具脚本/语音对话模式.py
    python3 07-工具区/工具脚本/语音对话模式.py --speaker master
    python3 07-工具区/工具脚本/语音对话模式.py --max-rounds 10
"""
...
class VoiceDialogue:
    ...
    def __init__(self, speaker="auto", max_rounds=DEFAULT_MAX_ROUNDS,
        ...
        self.audio = AudioSensor(
            project_root / "03-引擎区" / "书童程序" / "数据" / "感官日志",
            CONFIG
        )
    ...
    async def speak(self, text):
        ...
        output_path = project_root / "05-交付区" / "临时交付" / "对话回应.mp3"
    ...
    async def run(self, play_intro=True):
        ...
        print("\n[对话] 已结束")
        print(f"[记忆] 已保存到 {project_root / '03-引擎区' / '书童程序' / '数据' / '修行记录'}")
