...
用法：
    python3 07-工具区/工具脚本/快速桥接.py set master                 # 设置当前身份为师父
    python3 07-工具区/工具脚本/快速桥接.py set child 小橙子            # 设置当前身份为小橙子
    python3 07-工具区/工具脚本/快速桥接.py who                         # 查看当前身份
    python3 07-工具区/工具脚本/快速桥接.py clear                       # 清除当前身份
    python3 07-工具区/工具脚本/快速桥接.py chat "你好" "你好呀"          # 处理对话（使用当前身份）
    python3 07-工具区/工具脚本/快速桥接.py child 小橙子 "你好" "你好呀"  # 处理孩子对话
    python3 07-工具区/工具脚本/快速桥接.py master "你好" "你好呀"        # 处理师父对话
"""
...
def run_bridge(args):
    ...
    result = subprocess.run(cmd, cwd=PROJECT_ROOT / "03-引擎区", capture_output=False, text=True)
