...
class G1HTTPClient:
    ...
    #   wave_under_head     头下挥手（小幅致意）
    #   blow_kiss_right     右手飞吻（表达感谢）
    #   turn_back_wave      转身挥手（互动致意）
    SAFE_ARM_ACTIONS = {
        "face_wave", "high_wave", "shake_hand_arm", "clap", "high_five",
        "hug", "heart", "hands_up", "two_hand_kiss", "release_arm",
        "right_hand_on_heart", "wave_under_head", "blow_kiss_right", "blow_kiss_left", "turn_back_wave",
    }
    ...
    BOOKBOY_TO_G1_ACTION = {
        ...
        # ── 演讲用小幅度手臂动作（2026-07-03 新增）──
        "right_hand_on_heart": ("arm_action", "right_hand_on_heart"),  # 右手放心口
        "wave_under_head": ("arm_action", "wave_under_head"),          # 头下挥手
        "blow_kiss_right": ("arm_action", "blow_kiss_right"),          # 右手飞吻
        "blow_kiss_left": ("arm_action", "blow_kiss_left"),            # 左手飞吻
        "turn_back_wave": ("arm_action", "turn_back_wave"),            # 转身挥手
